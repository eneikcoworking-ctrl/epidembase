...
<div class="container mx-auto px-4 py-8 md:py-12">
	{#if item}
		<div class="max-w-4xl mx-auto">
			<a href="/" class="text-blue-600 hover:underline mb-8 inline-flex items-center text-sm font-medium">
			...
			<header class="mb-8">
				...
				<h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">{item.title}</h1>
			...
			<div class="prose prose-blue max-w-none bg-white p-6 md:p-10 rounded-xl shadow-sm border border-gray-100">
				{@html item.content}
			</div>
			...
			<div class="mt-12 pt-8 border-t border-gray-200 flex flex-col md:flex-row items-center justify-between gap-6">
